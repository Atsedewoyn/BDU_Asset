        ...
        <span v-bind="attrs" v-on="on" style="cursor:pointer" class="mx-5 mr-10">
          <v-chip link>
            <v-badge dot bottom offset-y="10" offset-x="10" color="green">
              <v-avatar size="40">
                <v-img aspect-ratio="30" src="https://simg.nicepng.com/png/small/263-2635963_admin-png.png"></v-img>
              </v-avatar>
  ...
  data: () => ({
    ...
    items: [
      ...
      { divider: true, inset: true },
      {
        ...
        to Alex, Scott, Jennifer </span> & mdash; Wish I could come, but I'm out of town this weekend.,`
      },
      { divider: true, inset: true },
      {
