                  ...
                  <v-dialog v-model="showEdit" persistent :overlay="false" max-width="500px" transition="dialog-transition">
                      <v-card class="text-center">
                          ...
                          <v-card-text>
                              ...
                              <v-text-field v-model="order_edit.password" label="Buying_price" required>
                              </v-text-field>
                          ...
                          <v-card-actions>
                              <v-spacer></v-spacer>
                              <v-btn @click="editUsers" color="success">Save</v-btn>
                  ...
                  <v-dialog v-model="deleteForm" persistent :overlay="false" max-width="400px" transition="dialog-transition">
                      <v-card>
                          ...
                          <v-card-text>
                              ...
                              <h3>password   {{order_edit.password }}</h3>
          ...
          export default {
              ...
              methods: {
                  ...
                  deleteOrders() {
                      this.$apollo
                          .mutate({
                              mutation: mutationUsers.delete_user,
                              variables: {
