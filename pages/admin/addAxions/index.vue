                        ...
                        <v-flex v-if="showAdd">
                            <v-card>
                                ...
                                <v-card-text class="px-15">
                                    <v-text-field v-model="axion_form.axions_type" name="axions_type" label="Axion Type"
                                        outlined required>
                                    </v-text-field>
                                    <v-text-field v-model="axion_form.axions_amount" name="axions_amount"
                                        label="Axion Amount" outlined>
                                    </v-text-field>
                                    <v-text-field v-model="axion_form.selling_price" name="selling_price"
                                        label="Selling price" outlined>
                                    </v-text-field>
                                    <v-text-field v-model="axion_form.image_url" name="image_url"
                                        label="Axion Photo/logo" outlined>
                                    </v-text-field>
                                    <v-textarea v-model="axion_form.axions_description" name="axions_descriptions"
                                        label="Axions Descriptions" outlined>
                                    </v-textarea>
